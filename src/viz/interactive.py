...
class InteractiveSimulation(param.Parameterized):
    ...
    def view_u(self):
        ...
        return hv.Image(U.T, bounds=(0, 0, 1, 1), label="Substrate U").opts(
            cmap="Viridis",
            colorbar=True,
            xaxis=None,
            yaxis=None,
    ...
    def view_v(self):
        ...
        return hv.Image(V.T, bounds=(0, 0, 1, 1), label="Inflammation V").opts(
            cmap="Inferno",
            colorbar=True,
            xaxis=None,
            yaxis=None,
    ...
    def view(self):
        ...
        plots = pn.Row(self.view_u, self.view_v)
